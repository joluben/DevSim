#!/usr/bin/env python3
"""
Script para limpiar la base de datos del scheduler 
y resolver conflictos de jobs.
Ejecutar antes de reiniciar el backend cuando hay 
errores JobLookupError.
"""
...
def clear_scheduler_database():
    ...
    db_paths = [
        os.path.join(script_dir, "scheduler_jobs.db"),
        os.path.join(script_dir, "backend", "scheduler_jobs.db"),
        "scheduler_jobs.db",
            ...
            try:
                ...
                for table in tables:
                    ...
                    if "job" in table_name.lower():
                        ...
                        print(f"Limpiados {count} registros tabla {table_name}")
